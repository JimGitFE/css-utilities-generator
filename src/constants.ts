...
const commandsMap: CommandsMap = {
    init: { short: "-i", action: [true, "dist/commands/init.js"] },
    generate: { short: "-g", action: [true, "dist/commands/generator.js"] },
    check: { short: "-c", action: [true, "dist/commands/check.js"] },
    watch: { short: "-w", action: [true, "dist/commands/watch.js"] },
...
const [shortKeys, shortValues]: [Dictionary["shortKeys"], Dictionary["shortValues"]] = [
    { ...dictionary.shortKeys, ...extendKeys },
    { ...dictionary.shortValues, ...extendValues },
];
